...
const PrintedLayout: React.FC<PrintedLayoutProps> = ({ selected }) => {
  ...
  return (
    <div>
      <div
        className="m-6 absolute left-[25%] w-[50%] p-6 border-8 border-[#1f7fc3]"
        id="test"
      >
        <div className="flex flex-col ">
          <Header />
          {selectedReport.length > 0 ? (
            <div aria-label="Report Content" className="flex flex-col gap-4 ">
              <div className="flex relative justify-center before:content-[''] before:absolute before:left-0 before:top-3 before:w-full before:h-1 before:bg-[#1f7fc3] before:z-0">
                <span className="bg-white relative px-3.5 font-bold text-lg ">
                  REPORT
                </span>
              </div>
              <div className="border p-4 border-black">
                <div className="grid grid-cols-2 gap-3 items-center">
                  {ReportDetailFields.map((item, i) => (
                    <span
                      className="w-200px flex justify-between text"
                      key={i}
                    >
              ...
              <div>
                <span className=" flex justify-center border w-full border-black p-2 font-bold">
              ...
              <div
                ...
                className="grid grid-cols-4 py-2 border-b border-black text-center"
              >
              ...
              <div className="flex flex-col">
                ...
                {selectedReport[0].fields.map((item, i) => (
                  <div
                    key={i}
                    className="grid grid-cols-4 py-2 text-center items-center"
                  >
                    <span>{item.name}</span>
                    <span>
              ...
              <div className="flex flex-col items-end text-xl font-semibold text-left">
